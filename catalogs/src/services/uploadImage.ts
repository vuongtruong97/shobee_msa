...
async function deleteFileCloudinary() {
    const result = await v2.uploader.destroy('banners/suvbundqtnwugigyicm2')
    console.log(result)

    return result
}

export { diskUpload, uploadToCloudinary, deleteFileCloudinary }
