...
class RabbitWrapper {
    ...
    // channel
    private _userCreateChannel?: Channel
    ...
    get channels() {
        ...
        return {
            userCreateChannel: this._userCreateChannel,
    ...
    async createConnection(url: string | Options.Connect, socketOptions?: any) {
        ...
        this._userCreateChannel = await this._puhlishConnection.createChannel()
